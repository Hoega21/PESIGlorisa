                                    ...
                                    <div class="card-body card-block">
                                        <form action="" method="post" class="form-horizontal">
                                            ...
                                            <div class="card-footer">
                                                <input class="btn btn-outline-primary btn-lg btn-block" type="submit" name="RegistrarProveedor" value="Agregar">
                                            </div>
                                        </form>
                                        <?php 
                                        require ("../Conexion.php");
                                            ...
                                            if (isset($_POST['RegistrarProveedor'])) {
                                                ...
                                                $sql = $conexion->query("INSERT INTO Categoriap(nomCat,descCat) VALUES ('".$Categoria."','".$Descripcion."')");
                                                if ($sql) {
