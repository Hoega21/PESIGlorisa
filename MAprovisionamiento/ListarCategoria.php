                                        ...
                                        <form action="" method="post" class="form-horizontal">
                                            <div class="form-group row ">
                                                ...
                                                <div class="col-1 col-md-4">
                                                    <input class="btn btn-primary" type="submit" name="BuscarCategoria" value="Buscar" >
                                                </div>
                                            </div>
                            ...
                            <div class="col-lg-15">
                                <div class="table-responsive table--no-card m-b-30">
                                    ...
                                    <table class="table table-borderless table-striped table-earning" align="center">
                                        ...
                                        <tbody>
                                           <?php 
                                                             if (isset($_POST['BuscarCategoria'])==false){
                                        ...
                                        <?php
                                                                ...
                                                                $conexion = mysqli_connect($host,$usuario,$clave,$BaseDatos);
                                                                    $BuscarRuc1 = $_POST['ListarCategoria'];
                                                                    $sql= $conexion->query("SELECT * FROM Categoriap WHERE nomCat='".$BuscarRuc1."';");
