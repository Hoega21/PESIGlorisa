                                        ...
                                        <form action="" method="post" class="form-horizontal" >
                                            ...
                                            <div class="form-group row ">
                                                ...
                                                <div class="col-8 col-md-5">
                                                    <input type="text" id="text-input" name="BuscarRuc" placeholder="Buscar por RUC" class="form-control" >
                                                        ...
                                                        <table class="table table-borderless table-striped table-earning" align="center">
                                                            ...
                                                            <tbody>
                                                                <?php 
                                                                    ...
                                                                    $res=$con->query("select * from Proveedor where estado='Habilitado'");
