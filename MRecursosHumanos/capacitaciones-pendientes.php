...
<?php 
$status=1;
$sql = "SELECT * from capacitaciones c where str_to_date(c.fecha, '%Y-%m-%d')>now() ";
...
{         
      ?>  
                                        ...
                                        <tr>
                                            ...
                                            <td><?php  echo date('Y-m-d',htmlentities($result->hora));?></td>
          <td>
           <td><a href="capacitaciones-detalle.php?cid=<?php echo htmlentities($result->id);?>" class="waves-effect waves-light btn blue m-b-xs"  > Ver detalles</a></td>
                                    </tr>
                                         <?php $cnt++;} }?>
                                    </tbody>
                                </table>
