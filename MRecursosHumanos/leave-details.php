...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin | Detalles del Permiso</title>
                    ...
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Detalles del permiso</span>
...
{         
  ...
  <tr>
                                            ...
                                            <td><?php echo htmlentities($result->LeaveType);?></td>
                                             <td style="font-size:16px;"><b>Fecha de permiso :</b></td>
                                            <td>Desde: <?php echo htmlentities($result->FromDate);?> <br> Hasta: <?php echo htmlentities($result->ToDate);?></td>
                                            <td style="font-size:16px;"><b>Fecha de solicitud</b></td>
                                           <td><?php echo substr(htmlentities($result->PostingDate),0,10) ;?></td>
                                        </tr>

<tr>
                                             <td style="font-size:16px;"><b>Descripción de la licencia del empleado : </b></td>
                                            <td colspan="2"><?php echo htmlentities($result->Description);?></td>
                                          <td style="font-size:16px;"><b>Documentos Adjuntados</b></td>
                                           <td>
                                              <button type="button" name="apply" id="apply" class="waves-effect waves-light btn indigo m-b-xs">Descargar Documentos</button> 
                                           </td>
                                        </tr>
