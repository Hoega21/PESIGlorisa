...
$sql="INSERT INTO tblpostulantes(EmpId,FirstName,LastName,EmailId,Password,Gender,Dob,Department,Address,City,Country,Phonenumber) VALUES(:empid,:fname,:lname,:email,:password,:gender,:dob,:department,:address,:city,:country,:mobileno)";
...
error:function (){}
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Agregar Postulante</div>
                    </div>
...
<input  name="puesto" type="text" id="puesto" autocomplete="off" required>
</div>
<button type="button" name="add" id="add" class="waves-effect waves-light btn indigo m-b-xs">Subir Documentos</button>
</div>
</div>
