...
?>                            
                    ...
                    <div class="col s8 m8 l3">
                        <div class="card stats-card">
                            <div class="card-content">
                                <span class="card-title">Permisos por aprobar</span>
                                    <?php
$sql = "SELECT id from  tblleavetype where Status=0";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
...
?>   
                        ...
                        <div class="card stats-card">
                            <div class="card-content">
                                <span class="card-title">Capacitaciones hechas</span>
                                    <?php
                             ...
                             <table id="example" class="display responsive-table ">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="120">Tipo de permisos</th>
