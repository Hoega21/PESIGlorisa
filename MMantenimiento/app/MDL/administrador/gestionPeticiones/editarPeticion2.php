<?php
  ...
  //
  $query = "update peticion set descripcion = upper('$descripcion'), nota = upper('$nota'), idOrdenTrabajo = '$ordenTrabajo', prioridad = '$prioridad', fechaPrevista = '$fechaPrevista', progreso = 'EN PROCESO' where id = '$id'";
