<?php
  ...
  $query = "select equipo.id, equipo.descripcion, equipo.idCategoria, categoria.descripcion as categoria, concat('[',categoria.iniciales,'] ',equipo.serie) as codigo, equipo.referencia, equipo.costo from equipo inner join categoria on categoria.id = equipo.idCategoria where equipo.estado = 1";
  //
