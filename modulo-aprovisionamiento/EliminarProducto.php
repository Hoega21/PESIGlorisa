                                        ...
                                        <form action="" method="post" class="form-horizontal">
                                            <div class="form-group row ">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Codigo producto</label>
                                                </div>
                                                <div class="col-8 col-md-5">
                                                    <input type="text" id="text-input" name="EliminarProducto" placeholder="Buscar por nombre" class="form-control" >
