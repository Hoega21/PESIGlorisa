                            ...
                            <div class="col-lg-8">
                                <div class="card">
                                        ...
                                        <form action="" method="post" class="form-horizontal">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="text-input" name="categoria" placeholder="Categoria" class="form-control">
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-footer">
                                        <button type="button" class="btn btn-outline-primary btn-lg btn-block">Agregar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
