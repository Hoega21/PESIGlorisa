<?php
  ...
  $query = "insert into peticion values (uuid(), upper('$descripcion'), '$tipoMantenimiento', '$producto', NULL, '$solicitadoX', now(),'$fechaPrevista', NULL, '$prioridad', upper('$nota'), 'INICIO', 1)";
  // echo json_encode("$query");
  //
  try {
